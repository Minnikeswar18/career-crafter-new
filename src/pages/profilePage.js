                ...
                <ul className='profile-ul'>
                    <li>
                        <label htmlFor="tab1" role="button">
                            <svg className='profile-svg' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 128 128">
                    ...
                    <li title="Delivery Contents">
                        <label htmlFor="tab2" role="button">
                            ...
                            <svg className='profile-svg' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
                    ...
                    <li title="Returns">
                        <label htmlFor="tab4" role="button">
                            <svg className='profile-svg' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
